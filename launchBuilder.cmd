...
docker run -it --rm -v /var/run/docker.sock:/var/run/docker.sock -v %userprofile%\.gradle:/$HOME/.gradle -v %userprofile%\.helm:/$HOME/.helm -v "%cd%":$HOME/repo -w $HOME/repo -e MARK_OFF_CLUSTER_INVOCATION_ENV_VAR='dc' demo4echo/alpine_openjdk8_k8scdk:latest ash
